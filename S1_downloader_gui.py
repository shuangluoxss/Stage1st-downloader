...
class Login_Dialog(QWidget):
    ...
    def login(self):
        ...
        login(username, password, on_success=on_success, on_fail=on_fail)
    ...
    def refresh_progressbar(self, paras):
        if paras[0] == 'start':
            ...
            self.message.setText(
                '<div><div style="float:left;"><b>%s</b></div><div align="right" style="float:right;">%d/%d页</div></div>' % (
                paras[3], paras[1], paras[2]))
